...
async def send_kz_menu(callback: types.CallbackQuery):
    await callback.message.answer("""Есть ли рассрочка?
...
async def send_kz_menu(callback: types.CallbackQuery):
    await callback.message.answer("""Рассрочка бар ма?
...
Биотехнолог - жобалаушы, Наргиз Омарова: “Гуматпен емдеуді бастау өте маңызды (2 апта), себебі бұл барлық жинақталған зиянды заттарды, тас пен ауыр металдарды шығару үшін қажет. Содан кейін ғана детокс және капсул""")
